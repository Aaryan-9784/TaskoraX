      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Total Users" value={stats?.totalUsers || 0} icon={HiOutlineUsers} colorClass="bg-primary-50 text-primary-600" trend="up" trendValue="5%" sparklineColor="#A52A44" sparklineFill="rgba(165, 42, 68, 0.15)" sparklineData={[10, 15, 10, 20, 40, 60, 70, 50, 30, 20]} />
            ...
            <StatCard title="Total Admins" value={stats?.totalAdmins || 0} icon={HiOutlineUsers} colorClass="bg-accent-50 text-accent-600" trend="up" trendValue="2%" sparklineColor="#C82B51" sparklineFill="rgba(200, 43, 81, 0.15)" sparklineData={[20, 30, 25, 40, 45, 60, 55, 70, 80]} />
            <StatCard title="New Users (Month)" value={stats?.newUsersThisMonth || 0} icon={HiOutlineUsers} colorClass="bg-info-50 text-info-600 dark:bg-info-900/30 dark:text-info-400" trend="up" trendValue="24%" sparklineColor="#A52A44" sparklineFill="rgba(165, 42, 68, 0.15)" sparklineData={[10, 20, 15, 30, 25, 40, 35, 50, 80]} />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Total Projects" value={stats?.totalProjects || 0} icon={HiOutlineClipboardDocumentList} colorClass="bg-primary-50 text-primary-600" trend="up" trendValue="8%" sparklineColor="#A52A44" sparklineFill="rgba(165, 42, 68, 0.15)" sparklineData={[15, 20, 25, 20, 30, 45, 50, 60, 65]} />
            ...
            <StatCard title="Completed Projects" value={stats?.completedProjects || 0} icon={HiOutlineCheckCircle} colorClass="bg-info-50 text-info-600 dark:bg-info-900/30 dark:text-info-400" trend="up" trendValue="10%" sparklineColor="#A52A44" sparklineFill="rgba(165, 42, 68, 0.15)" sparklineData={[5, 10, 15, 20, 30, 40, 45, 50, 55]} />
        ...
        <section>
          <h2 className="text-lg font-bold text-text-primary mb-4 flex items-center gap-2">
            <span className="p-1.5 bg-accent-50 dark:bg-accent-900/20 rounded-lg">
              <HiOutlineClipboardDocumentList className="w-5 h-5 text-accent-600" />
            </span>
            Tasks
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Total Tasks" value={stats?.totalTasks || 0} icon={HiOutlineClipboardDocumentList} colorClass="bg-accent-50 text-accent-500" trend="up" trendValue="12%" sparklineColor="#d1d5db" sparklineFill="rgba(209, 213, 219, 0.4)" sparklineData={[10, 5, 10, 15, 30, 45, 60, 40, 20, 10]} />
            ...
            <StatCard title="Pending Tasks" value={stats?.pendingTasks || 0} icon={HiOutlineClock} colorClass="bg-warning-50 text-warning-500" trend="down" trendValue="5%" sparklineColor="#fbbf24" sparklineFill="rgba(251, 191, 36, 0.2)" sparklineData={[60, 40, 20, 10, 5, 8, 12, 15, 18]} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-surface-secondary rounded-xl p-6 shadow-sm border border-border/50">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="px-2.5 py-1 bg-primary-50 dark:bg-primary-500/10 text-primary-600 dark:text-primary-400 rounded-lg text-xs font-semibold">+14% vs last month</div>
            </div>
            
            <div className="h-72">
              {!analytics ? (
                <div className="h-full flex flex-col items-center justify-center text-slate-400">
                  <div className="w-8 h-8 border-4 border-primary-200 border-t-indigo-600 rounded-full animate-spin mb-4"></div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={userGrowthData} margin={{ top: 5, right: 0, bottom: 5, left: -20 }} barSize={36}>
                    ...
                    <Tooltip 
                      ...
                      itemStyle={{ fontWeight: 700, color: '#800020' }}
          ...
          <div className="bg-white dark:bg-surface-secondary rounded-xl p-6 shadow-sm border border-border/50">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="p-1.5 bg-success-50 dark:bg-success-500/10 text-success-600 dark:text-success-400 rounded-lg">
            ...
            <div className="h-72 flex items-center justify-center">
              {!analytics ? (
                <div className="h-full w-full flex flex-col items-center justify-center text-slate-400">
                  <div className="w-8 h-8 border-4 border-success-200 border-t-emerald-600 rounded-full animate-spin mb-4"></div>
                  <span className="font-medium">Loading chart data...</span>
                </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={taskGrowthData} margin={{ top: 5, right: 0, bottom: 5, left: -20 }}>
                    ...
                    <Tooltip 
                      contentStyle={{ backgroundColor: '#ffffff', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)', padding: '10px 14px', fontSize: '13px' }}
                      itemStyle={{ fontWeight: 700, color: '#A52A44' }}
                      labelFormatter={(label) => new Date(label).toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                    />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-white dark:bg-surface-secondary rounded-xl p-6 shadow-sm border border-border/50">
            ...
            <div className="h-72 flex items-center justify-center">
              {!analytics ? (
                <div className="h-full flex flex-col items-center justify-center text-slate-400">
                  <div className="w-8 h-8 border-4 border-accent-200 border-t-rose-600 rounded-full animate-spin mb-4"></div>
                  <span className="font-medium">Loading chart data...</span>
                </div>
          ...
          <div className="bg-white dark:bg-surface-secondary rounded-xl p-6 shadow-sm border border-border/50">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="p-1.5 bg-warning-50 dark:bg-warning-500/10 text-warning-600 dark:text-warning-400 rounded-lg">
            ...
            <div className="h-72 flex items-center justify-center">
              {!analytics ? (
                <div className="h-full flex flex-col items-center justify-center text-slate-400">
                  <div className="w-8 h-8 border-4 border-warning-200 border-t-amber-600 rounded-full animate-spin mb-4"></div>
                  <span className="font-medium">Loading chart data...</span>
                </div>
      ...
      <div className="grid grid-cols-1 gap-6 mt-6">
        ...
        <div className="bg-white dark:bg-surface-secondary rounded-xl p-6 shadow-sm border border-border/50">
          ...
          <div className="h-72 flex items-center justify-center">
            {!analytics ? (
              <div className="h-full w-full flex flex-col items-center justify-center text-slate-400">
                <div className="w-8 h-8 border-4 border-primary-200 border-t-sky-600 rounded-full animate-spin mb-4"></div>
                <span className="font-medium">Loading chart data...</span>
              </div>
